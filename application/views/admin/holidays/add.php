...
<script>
	...
	$2(function() {
      ...
      echo form_open('holidays/add', $attributes);
      ?>
        <fieldset>        
          <div  class="main_container_width">
			  <div class="control-group double_part_div">
				...
				<div class="controls marginleft0">
				  <input type="text" id="holiday_name" name="holiday_name" value="<?php echo set_value('holiday_name'); ?>" class="width463" >
				</div>
			  </div>			  
		  ...
		  <div  class="main_container_width">
			  <div class="control-group double_part_div">
				...
				<div class="controls marginleft0">
				  <input type="text" id="holiday_date" name="holiday_date" value="<?php echo set_value('holiday_date'); ?>" class="width463" >
				</div>
			  </div>			  
			  <div class="classclear"></div>
		  </div>
