    <div class="container top">
      ...
      echo form_open('jilla/update/'.$this->uri->segment(3).'', $attributes);
      ?>
	  	<fieldset>        
          <div  class="main_container_width">
			  <div class="control-group double_part_div">
				...
				<div class="controls marginleft0">
				  <input type="text" id="jilla_name" name="jilla_name" value="<?php echo $jilla[0]['name']; ?>" class="width463" >
				</div>
			  </div>			  
		  ...
		  <div  class="main_container_width">
			  <div class="control-group double_part_div">
				...
				<div class="controls marginleft0">
				  <input type="text" id="jilla_name_guj" name="jilla_name_guj" value="<?php echo $jilla[0]['name_guj']; ?>" class="width463" >
				</div>
			  </div>			  
			  <div class="classclear"></div>
		  </div>
