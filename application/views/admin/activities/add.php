    ...
    <div class="container top">
      ...
      echo form_open('activities/add', $attributes);
      ?>
        <fieldset> 
			<div  class="main_container_width">
			  <div class="control-group double_part_div">
				...
				<div class="controls marginleft0">
				  <?php  echo form_dropdown('agegroup_id', $options_agegroup, set_value('agegroup_id'), 'class="span2 width230" id="agegroup_id"'); ?>
				</div>
			  </div>			  
          ...
          <div  class="main_container_width">
			  <div class="control-group double_part_div">
				...
				<div class="controls marginleft0">
				  <input type="text" id="activities_name" name="activities_name" value="<?php echo set_value('name'); ?>" class="width463" >
				</div>
			  </div>			  
			  <div class="classclear"></div>
		  </div>
