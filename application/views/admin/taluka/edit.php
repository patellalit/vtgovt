    <div class="container top">
      ...
      echo form_open('taluka/update/'.$this->uri->segment(3).'', $attributes);
      ?>
	  	<fieldset>        
			<div  class="main_container_width">
			  <div class="control-group double_part_div">
				...
				<div class="controls marginleft0">
				  <?php  echo form_dropdown('jilla_id', $options_jilla,  $taluka[0]['jilla_id'], 'class="span2 width230" id="jilla_id"'); ?>
				</div>
			  </div>			  
          ...
          <div  class="main_container_width">
			  <div class="control-group double_part_div">
				<label for="inputError" class="control-label form_label_css" >તાલુકો નામ (English) <span style="color:#ff0000">*</span></label>
				<div class="controls marginleft0">
				  <input type="text" id="taluka_name" name="taluka_name" value="<?php echo $taluka[0]['name']; ?>" class="width463" >
				</div>
			  </div>			  
			  <div class="classclear"></div>
		  </div>
		  <div  class="main_container_width">
			  <div class="control-group double_part_div">
				...
				<div class="controls marginleft0">
				  <input type="text" id="taluka_name_guj" name="taluka_name_guj" value="<?php echo $taluka[0]['name_guj']; ?>" class="width463" >
				</div>
			  </div>			  
			  <div class="classclear"></div>
		  </div>
