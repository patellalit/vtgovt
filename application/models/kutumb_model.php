...
//    echo '</pre>';
    ...
    */
    public function get_kutumb($jilla_id=null,$taluka_id=null,$gaam_id=null,$aanganwadiid_id=null,$search_string=null, $order=null, $order_type='Asc', $limit_start=null, $limit_end=null)
    {
		...
		if($search_string!=null)
		{
			//$this->db->where($this->table_name.'.family_rank',$search_string);
			if(!empty($familyidarray))
			{
				$this->db->where($this->table_name.'.family_id in ('.implode(',',$familyidarray).') or family_rank=\''.$search_string.'\'' );
			}
			else
			{
				$this->db->where($this->table_name.'.family_rank',$search_string);
    ...
    * @return int
    */
    function count_kutumb($jilla_id=null,$taluka_id=null,$gaam_id=null,$aanganwadiid_id=null,$search_string=null, $order=null, $order_type='Asc', $limit_start=null, $limit_end=null)
    {
		$familyidarray=array();
		if($search_string!=null)
		{
