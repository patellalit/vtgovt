...
//    echo '</pre>';
    ...
    * @return array
    */
    public function get_kutumb($jilla_id=null,$taluka_id=null,$gaam_id=null,$aanganwadiid_id=null,$search_string=null,$jati_id=null,$religion_id=null,$laghumati=null, $order=null, $order_type='Asc', $limit_start=null, $limit_end=null)
    {
		$familyidarray=array();
		if($search_string!=null)
		{
    ...
    */
    ...
    public function get_all_kutumb_details($type)
    {
        $this->db->select('*');
        $this->db->from($this->table_name);
        if($type=="6to3")
    ...
    public function getAllChildWithDifferentCategory($user_id)
    {
        ...
        $this->db->join($this->table_name,$this->table_name.'.family_id='.$this->person_table_name.'.family_id AND '.$this->table_name.'.anganwadi_id ='.$user_id,'left');
